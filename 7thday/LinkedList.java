...
public class LinkedList {
    ...
    public static void deleteAfter(int val){
        ...
        if(temp.next==null){
            System.err.println("list is reached to null  entry");
            return;
        }
        Node prev=temp.next;
        temp.next=prev.next;
...
//delete node before target node
public static void deleteBefore(int val){
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2.DELETE LIST  ITEM");
            System.out.println("3.SEARCH LIST ITEM");
            System.out.println("4.UPDATE LIST ITEM");
            System.out.println("5. DISPLAY LIST");
            System.out.println("6. SORT LIST ITEM IN ASCENDING ORDER");
            ...
            switch (n) {
                ...
                case 2:
                    ...
                    System.out.println("4. DELETE AFTER SPECIFIED NODE");
                    delete = sc.nextInt();
                    switch (delete) {
                        case 1:
                            deleteFirst();
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            System.out.println("Enter val that delete after it");
                            pos=sc.nextInt();
                            deleteAfter(pos);
                        default:
